...
public:
  ...
  // The initial pose is already in the map frame -- the TF is the node's to look up -- and `now`
  // stamps the search's debug markers, because this class reads no clock.
  [[nodiscard]] AlignResult align(
